...
export declare const isDataObject: (
  obj: string | number | ComplexOptionType | undefined,
  valueKey: string | undefined,
  labelKey: string | undefined
) => boolean;
export declare const hasItem: (
  all: string | number | ComplexOptionType | OptionsType | undefined,
  item: string | number | ComplexOptionType,
  valueKey?: string | undefined,
  labelKey?: string | undefined,
  returnIndex?: boolean
) => number | boolean;
export declare const hasItemIndex: (
  all: string | number | ComplexOptionType | OptionsType,
  item: string | number | ComplexOptionType,
  valueKey?: string | undefined,
  labelKey?: string | undefined
) => number;
